...
public class StudentTrainerDao {
	...
	public List<Student> saveStudentTrainerDao(List<Student> stList) {
...
// gpt code  in which we comunicate with class intity not
	...
	/*
	 * We can Not directly delete the trainer Details by First We have to make
	 * relationship(Foreign Key) null between Two table To Remove Association we
	 * have to find the trainer details to null association Create Delete native
	 * Query and and execute the by EcexecuteUpdate method class Code
	 * 
	 */
	...
	public boolean updateStudentEmailByStudentID(int studentID, String email) {
//		String selectQuery = "Select s From Student s where s.id=?1";
//		Query query = em.createQuery(selectQuery);
//		query.setParameter(1, studentID);
//		Student student = (Student) query.getSingleResult();
		// We CAn used both Query and find  method
